...
1. What are the main differences between a stateful and a functional component?
  ...
  stateful component holds the state while  functional component takes in props and returns jsx

2. When does a componentWillMount function be called? What about a componentWillUpdate?

  componentWillMount is called in the birth/mounting phase
  componentWillUpdate is called durning the growth/updating phase
...
4. What are the three step of creating a successful test? What is done in each phase? 
  ...
  arrange: renders a react element into the dom
  act: searching the dom to see if a specific node that we expect is there
  assert: confirming that the node we are looking for has rendered
